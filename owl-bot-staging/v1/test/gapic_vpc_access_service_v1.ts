...
describe('v1.VpcAccessServiceClient', () => {
    ...
    describe('getConnector', () => {
        it('invokes getConnector without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.vpcaccess.v1.GetConnectorRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.vpcaccess.v1.Connector());
            ...
            assert((client.innerApiCalls.getConnector as SinonStub)
    ...
    describe('createConnector', () => {
        it('invokes createConnector without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.vpcaccess.v1.CreateConnectorRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createConnector as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteConnector', () => {
        it('invokes deleteConnector without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteConnector as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listConnectors', () => {
        it('invokes listConnectors without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.vpcaccess.v1.ListConnectorsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listConnectors as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
