...
describe('v1.VpcAccessServiceClient', () => {
    ...
    describe('getConnector', () => {
        it('invokes getConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetConnectorRequest', ['name']);
    ...
    describe('createConnector', () => {
        it('invokes createConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateConnectorRequest', ['parent']);
    ...
    describe('deleteConnector', () => {
        it('invokes deleteConnector without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteConnectorRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listConnectors', () => {
        it('invokes listConnectors without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListConnectorsRequest', ['parent']);
            request.parent = defaultValue1;
